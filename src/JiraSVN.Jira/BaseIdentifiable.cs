...
{
	internal class BaseIdentifiable<T> : IIdentifiable
	{
		...
		public override bool Equals(object obj)
		{
			if (obj is BaseIdentifiable<T>)
				return Id == ((BaseIdentifiable<T>)obj).Id;
	...
	#region Simple Types:
	internal class JiraUser : BaseIdentifiable<RemoteUser>, IIssueUser
	{
	...
	internal class JiraStatus : BaseIdentifiable<RemoteStatus>, IIssueState
	{
	...
	internal class JiraAction : BaseIdentifiable<RemoteNamedObject>, IIssueAction
	{
